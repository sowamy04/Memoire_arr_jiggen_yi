    ...
    public function load(ObjectManager $manager)
    {
        ...
        foreach ($profils as $key => $libelle) {
            ...
            if($profil->getLibelle() == "SUPER_ADMIN"){
                  ...
                  $password = $this->encoder->encodePassword ($super_admin, 'pass1234' );
                  $super_admin->setProfil ($profil )
        ...
        foreach ($regions as $key => $region) {
            ...
            if ($region == "Dakar"){
                ...
                $villes3 = ["Dalifort", "Djidah Thiaroye Kaw", "Guinaw Rail Nord", "Guinaw Rail Sud", "Pikine Est", "Pikine Nord", "Pikine Ouest", "Tivaouane Diacksao", "Diamaguène Sicap Mbao", "Mbao", "Thiaroye-sur-Mer", "Thiaroye Gare", "Keur Massar", "Malika", "Yeumbeul Nord", "Yeumbeul Sud"];
                ...
                $villes4 = ["Rufisque Est", "Rufisque Nord", "Rufisque Ouest", "Bargny", "Sébikotane", "Diamniadio", "Jaxaay-Parcelles-Niakoul Rab", "Sangalkam", "Sendou", "Yenne", "Bambylor", "Tivaouane Peulh-Niaga"];
